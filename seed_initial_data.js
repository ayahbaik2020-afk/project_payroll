const { initDb, encrypt, dbRun } = require('./src/database');
...
async function seed() {
  ...
  for (const emp of initialEmployees) {
    ...
    // Seed May 2026 attendance for each
    // Present: 21 days, 1 late, 0 absent.
    // Give some overtime: Andi 2 first, 4 next. Eko 4 first, 2 next.
    let otFirst = 0;
    let otNext = 0;
    let bonus = 0;
    let insentif = 0;
